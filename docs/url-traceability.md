...
| domain parser | 1-5 | `asciiDomainToASCII`（ASCII の近道）、`toASCII`（非 ASCII） | `asciiDomainToASCII_no_forbidden`, `asciiDomainToASCII_ne_empty`, `toASCII_no_forbidden`, `toASCII_ne_empty` | wpt, uts46-alabel, dommy | 済 |
